...
* [部署 Kubernetes](setup/README.md)
  * [使用 kubeadm 部署 kubernetes](setup/kubeadm.md)
  * [在 Docker Desktop 使用](setup/docker-desktop.md)
  * [一步步部署 kubernetes 集群](setup/systemd.md)
...
* [归档](archive/README.md)
  * [Mesos - 优秀的集群资源调度平台](archive/mesos/README.md)
    * [Mesos 简介](archive/mesos/intro.md)
    * [安装与使用](archive/mesos/installation.md)
    * [原理与架构](archive/mesos/architecture.md)
    * [Mesos 配置项解析](archive/mesos/configuration.md)
    * [日志与监控](archive/mesos/monitor.md)
    * [常见应用框架](archive/mesos/framework.md)
    * [本章小结](archive/mesos/summary.md)
  * [Docker Machine](archive/machine/README.md)
    * [安装](archive/machine/install.md)
    * [使用](archive/machine/usage.md)
  * [Docker Swarm](archive/swarm.md)
